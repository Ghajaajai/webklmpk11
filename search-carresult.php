...
<title>Mobilku | Car Listing</title>
<!--Bootstrap -->
      ...
      <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5 style="color: #dc0d0dbd;"><i class="fa fa-filter" aria-hidden="true"></i> Voltar </h5>
          </div>
...
<option value="Petrol">CNG</option>
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5 style="color: #dc0d0dbd;"><i class="fa fa-car" aria-hidden="true"></i> List Mobil</h5>
          </div>
